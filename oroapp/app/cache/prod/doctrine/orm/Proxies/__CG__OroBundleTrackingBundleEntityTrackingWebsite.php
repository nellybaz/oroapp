 ...
 */
class TrackingWebsite extends \Oro\Bundle\TrackingBundle\Entity\TrackingWebsite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'identifier', 'name', 'url', 'owner', 'createdAt', 'updatedAt', 'organization', 'serialized_data', 'extend_description', 'channel'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrackingWebsite $proxy) {
    ...
    public function setChannel($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setChannel', [$value]);

        return parent::setChannel($value);
    }
