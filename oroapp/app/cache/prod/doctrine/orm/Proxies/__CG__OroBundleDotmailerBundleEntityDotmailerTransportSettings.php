 ...
 */
class DotmailerTransportSettings extends \Oro\Bundle\DotmailerBundle\Entity\DotmailerTransportSettings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'channel', 'id', 'settings'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DotmailerTransportSettings $proxy) {
