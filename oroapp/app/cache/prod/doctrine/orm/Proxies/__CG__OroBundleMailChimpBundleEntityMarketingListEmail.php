 ...
 */
class MarketingListEmail extends \Oro\Bundle\MailChimpBundle\Entity\MarketingListEmail implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'marketingList', 'email', 'state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MarketingListEmail $proxy) {
