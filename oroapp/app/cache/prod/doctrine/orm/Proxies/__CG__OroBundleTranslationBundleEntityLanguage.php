...
namespace Proxies\__CG__\Oro\Bundle\TranslationBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Language extends \Oro\Bundle\TranslationBundle\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'code', 'enabled', 'installedBuildDate', 'createdAt', 'updatedAt', 'updatedAtSet', 'owner', 'organization'];
        }
    ...
    public function setInstalledBuildDate(\DateTime $installedBuildDate = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInstalledBuildDate', [$installedBuildDate]);

        return parent::setInstalledBuildDate($installedBuildDate);
    }
    ...
    public function getInstalledBuildDate()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getInstalledBuildDate', []);

        return parent::getInstalledBuildDate();
    }
