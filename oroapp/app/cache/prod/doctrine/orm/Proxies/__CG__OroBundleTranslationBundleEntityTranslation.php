 ...
 */
class Translation extends \Oro\Bundle\TranslationBundle\Entity\Translation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'translationKey', 'value', 'language', 'scope'];
        }
     ...
     * {@inheritDoc}
     */
    public function setLanguage(\Oro\Bundle\TranslationBundle\Entity\Language $language)
    {
