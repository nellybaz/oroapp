 ...
 */
class MarketingListRemovedItem extends \Oro\Bundle\MarketingListBundle\Entity\MarketingListRemovedItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MarketingListRemovedItem $proxy) {
