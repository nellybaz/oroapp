 ...
 */
class LeadMailboxProcessSettings extends \Oro\Bundle\SalesBundle\Entity\LeadMailboxProcessSettings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'owner', 'channel', 'source', 'id', 'mailbox'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LeadMailboxProcessSettings $proxy) {
