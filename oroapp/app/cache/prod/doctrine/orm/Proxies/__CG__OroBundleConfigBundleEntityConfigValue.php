 ...
 */
class ConfigValue extends \Oro\Bundle\ConfigBundle\Entity\ConfigValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'config', 'section', 'textValue', 'objectValue', 'arrayValue', 'type', 'createdAt', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ConfigValue $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setConfig(\Oro\Bundle\ConfigBundle\Entity\Config $config)
    {
    ...
    public function clearValue()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'clearValue', []);

        return parent::clearValue();
    }
