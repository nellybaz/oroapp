 ...
 */
class IndexDatetime extends \Oro\Bundle\WebsiteSearchBundle\Entity\IndexDatetime implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IndexDatetime $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setItem(\Oro\Bundle\SearchBundle\Entity\AbstractItem $item)
    {
