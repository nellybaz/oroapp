 ...
 */
class EV_Dm_Cnt_Opt_In_Type extends \Extend\Entity\EV_Dm_Cnt_Opt_In_Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Dm_Cnt_Opt_In_Type $proxy) {
