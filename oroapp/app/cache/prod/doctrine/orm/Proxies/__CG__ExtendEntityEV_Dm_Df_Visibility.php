 ...
 */
class EV_Dm_Df_Visibility extends \Extend\Entity\EV_Dm_Df_Visibility implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Dm_Df_Visibility $proxy) {
