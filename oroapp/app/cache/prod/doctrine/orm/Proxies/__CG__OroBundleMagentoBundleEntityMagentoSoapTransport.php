 ...
 */
class MagentoSoapTransport extends \Oro\Bundle\MagentoBundle\Entity\MagentoSoapTransport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'isWsiMode', 'wsdlCachePath', 'apiUrl', 'apiUser', 'apiKey', 'syncStartDate', 'initialSyncStartDate', 'syncRange', 'websiteId', 'websites', 'isExtensionInstalled', 'extensionVersion', 'magentoVersion', 'guestCustomerSync', 'isDisplayOrderNotes', 'adminUrl', 'newsletterSubscriberSyncedToId', 'sharedGuestEmailList', 'settings', 'id', 'channel'];
        }
    ...
    public function setWsdlCachePath($wsdlCachePath)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setWsdlCachePath', [$wsdlCachePath]);
    ...
    public function setIsWsiMode($isWsiMode)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsWsiMode', [$isWsiMode]);
    ...
    public function getIsWsiMode()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsWsiMode', []);
