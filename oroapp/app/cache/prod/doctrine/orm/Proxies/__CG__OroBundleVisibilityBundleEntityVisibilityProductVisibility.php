 ...
 */
class ProductVisibility extends \Oro\Bundle\VisibilityBundle\Entity\Visibility\ProductVisibility implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'product', 'scope', 'visibility'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductVisibility $proxy) {
