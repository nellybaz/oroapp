 ...
 */
class PaymentStatus extends \Oro\Bundle\PaymentBundle\Entity\PaymentStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'entityClass', 'entityIdentifier', 'paymentStatus'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PaymentStatus $proxy) {
