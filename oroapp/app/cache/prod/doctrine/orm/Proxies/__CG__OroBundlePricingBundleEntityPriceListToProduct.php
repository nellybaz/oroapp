 ...
 */
class PriceListToProduct extends \Oro\Bundle\PricingBundle\Entity\PriceListToProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'priceList', 'product', 'manual'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PriceListToProduct $proxy) {
