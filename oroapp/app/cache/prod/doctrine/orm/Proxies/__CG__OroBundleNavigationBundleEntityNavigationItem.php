 ...
 */
class NavigationItem extends \Oro\Bundle\NavigationBundle\Entity\NavigationItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'user', 'type', 'id', 'title', 'position', 'organization', 'url', 'createdAt', 'updatedAt', 'updatedAtSet'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NavigationItem $proxy) {
