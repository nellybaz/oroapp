 ...
 */
class Address extends \Oro\Bundle\MagentoBundle\Entity\Address implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'label', 'street', 'street2', 'city', 'postalCode', 'country', 'region', 'regionText', 'namePrefix', 'firstName', 'middleName', 'lastName', 'nameSuffix', 'owner', 'phone', 'types', 'contactAddress', 'contactPhone', 'syncState', 'serialized_data', 'primary', 'id', 'organization', 'created', 'updated', 'channel', 'originId', 'countryText'];
        }
     ...
     * {@inheritDoc}
     */
    public function setOwner(\Oro\Bundle\MagentoBundle\Entity\Customer $owner = NULL)
    {
