 ...
 */
class DiscountConfiguration extends \Oro\Bundle\PromotionBundle\Entity\DiscountConfiguration implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'type', 'options', 'serialized_data'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DiscountConfiguration $proxy) {
