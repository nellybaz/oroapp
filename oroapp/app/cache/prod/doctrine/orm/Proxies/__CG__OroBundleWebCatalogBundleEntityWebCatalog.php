 ...
 */
class WebCatalog extends \Oro\Bundle\WebCatalogBundle\Entity\WebCatalog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'description', 'serialized_data', 'owner', 'organization', 'createdAt', 'updatedAt', 'updatedAtSet'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WebCatalog $proxy) {
