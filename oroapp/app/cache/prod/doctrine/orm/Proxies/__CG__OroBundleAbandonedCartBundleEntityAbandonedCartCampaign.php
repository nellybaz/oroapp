 ...
 */
class AbandonedCartCampaign extends \Oro\Bundle\AbandonedCartBundle\Entity\AbandonedCartCampaign implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'marketingList', 'campaign'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AbandonedCartCampaign $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCampaign(\Oro\Bundle\CampaignBundle\Entity\Campaign $campaign)
    {
