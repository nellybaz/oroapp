 ...
 */
class PriceAttributeCurrency extends \Oro\Bundle\PricingBundle\Entity\PriceAttributeCurrency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PriceAttributeCurrency $proxy) {
