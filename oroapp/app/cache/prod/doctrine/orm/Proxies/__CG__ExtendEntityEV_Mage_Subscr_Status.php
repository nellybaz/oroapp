 ...
 */
class EV_Mage_Subscr_Status extends \Extend\Entity\EV_Mage_Subscr_Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Mage_Subscr_Status $proxy) {
