 ...
 */
class IndexDecimal extends \Oro\Bundle\WebsiteSearchBundle\Entity\IndexDecimal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IndexDecimal $proxy) {
