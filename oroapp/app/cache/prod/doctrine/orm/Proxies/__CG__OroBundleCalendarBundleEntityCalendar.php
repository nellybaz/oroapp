 ...
 */
class Calendar extends \Oro\Bundle\CalendarBundle\Entity\Calendar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'owner', 'events', 'organization', 'serialized_data'];
        }
