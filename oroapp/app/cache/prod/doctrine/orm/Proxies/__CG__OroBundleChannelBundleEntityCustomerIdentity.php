 ...
 */
class CustomerIdentity extends \Oro\Bundle\ChannelBundle\Entity\CustomerIdentity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'account', 'contact', 'owner', 'createdAt', 'updatedAt', 'serialized_data', 'dataChannel'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomerIdentity $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setContact(\Oro\Bundle\ContactBundle\Entity\Contact $contact)
    {
