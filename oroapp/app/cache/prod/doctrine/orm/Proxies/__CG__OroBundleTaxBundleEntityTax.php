 ...
 */
class Tax extends \Oro\Bundle\TaxBundle\Entity\Tax implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'code', 'description', 'rate', 'createdAt', 'updatedAt', 'updatedAtSet'];
        }
