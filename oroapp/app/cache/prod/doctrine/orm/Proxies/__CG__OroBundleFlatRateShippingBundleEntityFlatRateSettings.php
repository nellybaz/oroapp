...
namespace Proxies\__CG__\Oro\Bundle\FlatRateShippingBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class FlatRateSettings extends \Oro\Bundle\FlatRateShippingBundle\Entity\FlatRateSettings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Oro\\Bundle\\FlatRateShippingBundle\\Entity\\FlatRateSettings' . "\0" . 'labels', '' . "\0" . 'Oro\\Bundle\\FlatRateShippingBundle\\Entity\\FlatRateSettings' . "\0" . 'settings', 'id', 'channel'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FlatRateSettings $proxy) {
