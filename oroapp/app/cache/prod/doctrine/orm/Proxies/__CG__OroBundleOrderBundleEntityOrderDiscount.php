 ...
 */
class OrderDiscount extends \Oro\Bundle\OrderBundle\Entity\OrderDiscount implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'description', 'percent', 'amount', 'amountPrice', 'order', 'type'];
        }
    ...
    public function getAmountPrice()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAmountPrice', []);

        return parent::getAmountPrice();
    }
