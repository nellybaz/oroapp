 ...
 */
class MenuUpdate extends \Oro\Bundle\NavigationBundle\Entity\MenuUpdate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'serialized_data', 'id', 'key', 'parentKey', 'titles', 'descriptions', 'uri', 'menu', 'scope', 'icon', 'active', 'priority', 'divider', 'custom'];
        }
