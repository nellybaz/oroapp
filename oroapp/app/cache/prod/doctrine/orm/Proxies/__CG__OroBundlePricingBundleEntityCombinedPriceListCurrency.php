 ...
 */
class CombinedPriceListCurrency extends \Oro\Bundle\PricingBundle\Entity\CombinedPriceListCurrency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CombinedPriceListCurrency $proxy) {
