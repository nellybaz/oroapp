 ...
 */
class EV_Dm_Cmp_Reply_Action extends \Extend\Entity\EV_Dm_Cmp_Reply_Action implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Dm_Cmp_Reply_Action $proxy) {
