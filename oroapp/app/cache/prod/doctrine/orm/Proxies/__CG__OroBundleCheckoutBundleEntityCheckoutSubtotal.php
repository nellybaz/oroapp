 ...
 */
class CheckoutSubtotal extends \Oro\Bundle\CheckoutBundle\Entity\CheckoutSubtotal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'checkout', 'currency', 'value', 'combinedPriceList', 'valid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CheckoutSubtotal $proxy) {
