 ...
 */
class ShoppingListTotal extends \Oro\Bundle\ShoppingListBundle\Entity\ShoppingListTotal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'shoppingList', 'currency', 'subtotalValue', 'valid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ShoppingListTotal $proxy) {
