 ...
 */
class EV_Prod_Inventory_Status extends \Extend\Entity\EV_Prod_Inventory_Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Prod_Inventory_Status $proxy) {
