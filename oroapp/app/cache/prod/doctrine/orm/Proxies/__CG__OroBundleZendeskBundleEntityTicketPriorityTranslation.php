 ...
 */
class TicketPriorityTranslation extends \Oro\Bundle\ZendeskBundle\Entity\TicketPriorityTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TicketPriorityTranslation $proxy) {
