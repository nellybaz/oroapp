 ...
 */
class EV_Dm_Import_Status extends \Extend\Entity\EV_Dm_Import_Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Dm_Import_Status $proxy) {
