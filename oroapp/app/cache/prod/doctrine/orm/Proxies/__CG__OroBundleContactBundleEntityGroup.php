 ...
 */
class Group extends \Oro\Bundle\ContactBundle\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'label', 'owner', 'organization', 'serialized_data'];
        }
    ...
    public function setLabel($name)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLabel', [$name]);
