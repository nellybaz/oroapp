 ...
 */
class B2bCustomerPhone extends \Oro\Bundle\SalesBundle\Entity\B2bCustomerPhone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'owner', 'serialized_data', 'id', 'phone', 'primary'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (B2bCustomerPhone $proxy) {
