 ...
 */
class FieldMapping extends \Akeneo\Bundle\BatchBundle\Entity\FieldMapping implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'source', 'destination', 'identifier', 'item'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FieldMapping $proxy) {
    ...
    public function isIdentifier()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isIdentifier', []);

        return parent::isIdentifier();
    }
