 ...
 */
class MarketingListUnsubscribedItem extends \Oro\Bundle\MarketingListBundle\Entity\MarketingListUnsubscribedItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'entityId', 'marketingList', 'createdAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MarketingListUnsubscribedItem $proxy) {
