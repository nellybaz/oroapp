 ...
 */
class EV_Opportunity_Status extends \Extend\Entity\EV_Opportunity_Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Opportunity_Status $proxy) {
