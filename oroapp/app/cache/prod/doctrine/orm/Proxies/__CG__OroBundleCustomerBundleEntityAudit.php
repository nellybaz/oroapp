 ...
 */
class Audit extends \Oro\Bundle\CustomerBundle\Entity\Audit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'customerUser', 'id', 'action', 'loggedAt', 'objectId', 'objectClass', 'objectName', 'version', 'fields', 'organization', 'impersonation', 'transactionId', 'ownerDescription', 'additionalFields'];
        }
