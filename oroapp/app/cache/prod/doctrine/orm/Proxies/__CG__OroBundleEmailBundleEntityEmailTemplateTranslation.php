 ...
 */
class EmailTemplateTranslation extends \Oro\Bundle\EmailBundle\Entity\EmailTemplateTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmailTemplateTranslation $proxy) {
