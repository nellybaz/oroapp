 ...
 */
class CustomerGroupProductVisibility extends \Oro\Bundle\VisibilityBundle\Entity\Visibility\CustomerGroupProductVisibility implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomerGroupProductVisibility $proxy) {
