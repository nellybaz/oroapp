 ...
 */
class ContactPhone extends \Oro\Bundle\ContactBundle\Entity\ContactPhone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContactPhone $proxy) {
