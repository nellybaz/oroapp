 ...
 */
class CombinedPriceList extends \Oro\Bundle\PricingBundle\Entity\CombinedPriceList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'enabled', 'prices', 'currencies', 'pricesCalculated', 'id', 'name', 'createdAt', 'updatedAt', 'updatedAtSet'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CombinedPriceList $proxy) {
    ...
    public function isPricesCalculated()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isPricesCalculated', []);

        return parent::isPricesCalculated();
    }
    ...
    public function setPricesCalculated($pricesCalculated)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPricesCalculated', [$pricesCalculated]);

        return parent::setPricesCalculated($pricesCalculated);
    }
