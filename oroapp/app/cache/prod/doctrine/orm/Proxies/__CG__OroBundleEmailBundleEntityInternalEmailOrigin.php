 ...
 */
class InternalEmailOrigin extends \Oro\Bundle\EmailBundle\Entity\InternalEmailOrigin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'internalName', 'id', 'mailboxName', 'folders', 'emailUsers', 'isActive', 'syncCodeUpdatedAt', 'synchronizedAt', 'syncCode', 'syncCount', 'owner', 'organization', 'mailbox'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InternalEmailOrigin $proxy) {
