 ...
 */
class TicketStatusTranslation extends \Oro\Bundle\ZendeskBundle\Entity\TicketStatusTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TicketStatusTranslation $proxy) {
