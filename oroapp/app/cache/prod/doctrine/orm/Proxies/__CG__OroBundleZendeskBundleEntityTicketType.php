 ...
 */
class TicketType extends \Oro\Bundle\ZendeskBundle\Entity\TicketType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     * {@inheritDoc}
     */
    public function isEqualTo(\Oro\Bundle\ZendeskBundle\Entity\TicketType $other)
    {
