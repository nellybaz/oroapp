...
namespace Proxies\__CG__\Oro\Bundle\NavigationBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class NavigationHistoryItem extends \Oro\Bundle\NavigationBundle\Entity\NavigationHistoryItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'user', 'id', 'title', 'visitedAt', 'visitCount', 'route', 'routeParameters', 'entityId', 'organization', 'url'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NavigationHistoryItem $proxy) {
    ...
    public function setVisitedAt($visitedAt)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVisitedAt', [$visitedAt]);

        return parent::setVisitedAt($visitedAt);
    }
    ...
    public function getVisitedAt()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVisitedAt', []);

        return parent::getVisitedAt();
    }
