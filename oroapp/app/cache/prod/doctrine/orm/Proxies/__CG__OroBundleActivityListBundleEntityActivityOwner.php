 ...
 */
class ActivityOwner extends \Oro\Bundle\ActivityListBundle\Entity\ActivityOwner implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'activity', 'organization', 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ActivityOwner $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setActivity(\Oro\Bundle\ActivityListBundle\Entity\ActivityList $activity = NULL)
    {
    ...
    public function isOwnerInCollection($stack)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isOwnerInCollection', [$stack]);

        return parent::isOwnerInCollection($stack);
    }
