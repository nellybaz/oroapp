 ...
 */
class PriceListToCustomerGroup extends \Oro\Bundle\PricingBundle\Entity\PriceListToCustomerGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'customerGroup', 'id', 'sortOrder', 'priceList', 'website', 'mergeAllowed'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PriceListToCustomerGroup $proxy) {
