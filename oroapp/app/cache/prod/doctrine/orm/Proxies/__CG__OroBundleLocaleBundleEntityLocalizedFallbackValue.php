 ...
 */
class LocalizedFallbackValue extends \Oro\Bundle\LocaleBundle\Entity\LocalizedFallbackValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'fallback', 'string', 'text', 'localization', 'serialized_data'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LocalizedFallbackValue $proxy) {
    ...
    public function setString($string)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setString', [$string]);
    ...
    public function getString()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getString', []);
