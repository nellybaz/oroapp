 ...
 */
class EmailRecipient extends \Oro\Bundle\EmailBundle\Entity\EmailRecipient implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'type', 'emailAddress', 'email'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmailRecipient $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setEmailAddress(\Oro\Bundle\EmailBundle\Entity\EmailAddress $emailAddress)
    {
