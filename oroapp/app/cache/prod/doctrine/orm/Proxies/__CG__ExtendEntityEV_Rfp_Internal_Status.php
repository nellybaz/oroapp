 ...
 */
class EV_Rfp_Internal_Status extends \Extend\Entity\EV_Rfp_Internal_Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Rfp_Internal_Status $proxy) {
