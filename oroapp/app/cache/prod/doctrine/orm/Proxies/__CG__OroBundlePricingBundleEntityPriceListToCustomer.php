 ...
 */
class PriceListToCustomer extends \Oro\Bundle\PricingBundle\Entity\PriceListToCustomer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'customer', 'id', 'sortOrder', 'priceList', 'website', 'mergeAllowed'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PriceListToCustomer $proxy) {
