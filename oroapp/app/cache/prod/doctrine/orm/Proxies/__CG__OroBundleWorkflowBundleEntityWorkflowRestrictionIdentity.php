 ...
 */
class WorkflowRestrictionIdentity extends \Oro\Bundle\WorkflowBundle\Entity\WorkflowRestrictionIdentity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'restriction', 'entityId', 'workflowItem'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WorkflowRestrictionIdentity $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setRestriction(\Oro\Bundle\WorkflowBundle\Entity\WorkflowRestriction $restriction)
    {
