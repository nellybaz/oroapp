 ...
 */
class CasePriority extends \Oro\Bundle\CaseBundle\Entity\CasePriority implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'order', 'label', 'locale'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CasePriority $proxy) {
