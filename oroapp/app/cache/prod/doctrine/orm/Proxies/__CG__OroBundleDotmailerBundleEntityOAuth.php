 ...
 */
class OAuth extends \Oro\Bundle\DotmailerBundle\Entity\OAuth implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'channel', 'user', 'refreshToken'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OAuth $proxy) {
