 ...
 */
class CustomerGroup extends \Oro\Bundle\MagentoBundle\Entity\CustomerGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'serialized_data', 'id', 'channel', 'originId'];
        }
