 ...
 */
class Template extends \Oro\Bundle\MailChimpBundle\Entity\Template implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'originId', 'channel', 'owner', 'type', 'name', 'active', 'layout', 'category', 'previewImage', 'createdAt', 'updatedAt'];
        }
