 ...
 */
class EV_Quote_Customer_Status extends \Extend\Entity\EV_Quote_Customer_Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Quote_Customer_Status $proxy) {
