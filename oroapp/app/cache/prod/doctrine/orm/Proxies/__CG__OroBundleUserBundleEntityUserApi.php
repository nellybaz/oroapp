 ...
 */
class UserApi extends \Oro\Bundle\UserBundle\Entity\UserApi implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user', 'apiKey', 'organization'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserApi $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setUser(\Oro\Bundle\UserBundle\Entity\User $user)
    {
