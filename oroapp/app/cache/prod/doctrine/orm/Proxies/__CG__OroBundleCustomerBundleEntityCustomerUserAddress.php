 ...
 */
class CustomerUserAddress extends \Oro\Bundle\CustomerBundle\Entity\CustomerUserAddress implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'frontendOwner', 'types', 'phone', 'serialized_data', 'owner', 'systemOrganization', 'primary', 'id', 'label', 'street', 'street2', 'city', 'postalCode', 'country', 'region', 'organization', 'regionText', 'namePrefix', 'firstName', 'middleName', 'lastName', 'nameSuffix', 'created', 'updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomerUserAddress $proxy) {
    ...
    public function hasDefault($typeName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasDefault', [$typeName]);

        return parent::hasDefault($typeName);
    }
    ...
    public function getSystemOrganization()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSystemOrganization', []);

        return parent::getSystemOrganization();
    }

    /**
     * {@inheritDoc}
     */
    public function setSystemOrganization(\Oro\Bundle\OrganizationBundle\Entity\OrganizationInterface $systemOrganization = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSystemOrganization', [$systemOrganization]);

        return parent::setSystemOrganization($systemOrganization);
    }
