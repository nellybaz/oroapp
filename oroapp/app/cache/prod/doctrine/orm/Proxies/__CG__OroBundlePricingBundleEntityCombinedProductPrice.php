 ...
 */
class CombinedProductPrice extends \Oro\Bundle\PricingBundle\Entity\CombinedProductPrice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'priceList', 'mergeAllowed', 'id', 'product', 'productSku', 'quantity', 'unit', 'value', 'currency', 'price'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CombinedProductPrice $proxy) {
