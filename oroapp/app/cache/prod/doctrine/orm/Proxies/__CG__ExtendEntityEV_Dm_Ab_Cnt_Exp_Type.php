 ...
 */
class EV_Dm_Ab_Cnt_Exp_Type extends \Extend\Entity\EV_Dm_Ab_Cnt_Exp_Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Dm_Ab_Cnt_Exp_Type $proxy) {
