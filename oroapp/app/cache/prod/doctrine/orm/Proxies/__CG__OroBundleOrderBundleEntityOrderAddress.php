 ...
 */
class OrderAddress extends \Oro\Bundle\OrderBundle\Entity\OrderAddress implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'customerAddress', 'customerUserAddress', 'fromExternalSource', 'phone', 'serialized_data', 'id', 'label', 'street', 'street2', 'city', 'postalCode', 'country', 'region', 'organization', 'regionText', 'namePrefix', 'firstName', 'middleName', 'lastName', 'nameSuffix', 'created', 'updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrderAddress $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCustomerAddress(\Oro\Bundle\CustomerBundle\Entity\CustomerAddress $customerAddress = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function setCustomerUserAddress(\Oro\Bundle\CustomerBundle\Entity\CustomerUserAddress $customerUserAddress = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCustomerUserAddress', [$customerUserAddress]);

        return parent::setCustomerUserAddress($customerUserAddress);
    }
    ...
    public function getCustomerUserAddress()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCustomerUserAddress', []);

        return parent::getCustomerUserAddress();
    }
