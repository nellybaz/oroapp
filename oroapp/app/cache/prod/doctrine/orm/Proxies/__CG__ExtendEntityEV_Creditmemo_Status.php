 ...
 */
class EV_Creditmemo_Status extends \Extend\Entity\EV_Creditmemo_Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Creditmemo_Status $proxy) {
