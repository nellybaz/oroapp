 ...
 */
class TrackingData extends \Oro\Bundle\TrackingBundle\Entity\TrackingData implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'data', 'event', 'createdAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrackingData $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setEvent(\Oro\Bundle\TrackingBundle\Entity\TrackingEvent $event = NULL)
    {
