 ...
 */
class CustomerTaxCode extends \Oro\Bundle\TaxBundle\Entity\CustomerTaxCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'code', 'description', 'createdAt', 'updatedAt', 'updatedAtSet', 'owner', 'organization'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomerTaxCode $proxy) {
