 ...
 */
class EV_Acc_Internal_Rating extends \Extend\Entity\EV_Acc_Internal_Rating implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Acc_Internal_Rating $proxy) {
