 ...
 */
class TranslationKey extends \Oro\Bundle\TranslationBundle\Entity\TranslationKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'key', 'domain'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TranslationKey $proxy) {
