 ...
 */
class AutoResponseRule extends \Oro\Bundle\EmailBundle\Entity\AutoResponseRule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'active', 'template', 'mailbox', 'createdAt', 'definition'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AutoResponseRule $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setMailbox(\Oro\Bundle\EmailBundle\Entity\Mailbox $mailbox)
    {
