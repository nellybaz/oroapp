 ...
 */
class EV_Ce_Attendee_Type extends \Extend\Entity\EV_Ce_Attendee_Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Ce_Attendee_Type $proxy) {
