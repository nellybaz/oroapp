 ...
 */
class LeadAddress extends \Oro\Bundle\SalesBundle\Entity\LeadAddress implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'owner', 'primary', 'serialized_data', 'id', 'label', 'street', 'street2', 'city', 'postalCode', 'country', 'region', 'organization', 'regionText', 'namePrefix', 'firstName', 'middleName', 'lastName', 'nameSuffix', 'created', 'updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LeadAddress $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setOwner(\Oro\Bundle\SalesBundle\Entity\Lead $owner = NULL)
    {
