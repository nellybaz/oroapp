 ...
 */
class Group extends \Oro\Bundle\UserBundle\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'roles', 'owner', 'organization', 'serialized_data'];
        }
    ...
    public function getRoleLabelsAsString()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRoleLabelsAsString', []);
