 ...
 */
class UserRoleTranslation extends \Oro\Bundle\ZendeskBundle\Entity\UserRoleTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserRoleTranslation $proxy) {
