 ...
 */
class Taxonomy extends \Oro\Bundle\TagBundle\Entity\Taxonomy implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'created', 'updated', 'tags', 'owner', 'organization', 'backgroundColor', 'serialized_data'];
        }
