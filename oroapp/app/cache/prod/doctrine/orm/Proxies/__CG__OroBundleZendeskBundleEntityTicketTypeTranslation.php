 ...
 */
class TicketTypeTranslation extends \Oro\Bundle\ZendeskBundle\Entity\TicketTypeTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TicketTypeTranslation $proxy) {
