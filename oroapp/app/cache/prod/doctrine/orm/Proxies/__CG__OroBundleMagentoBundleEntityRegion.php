 ...
 */
class Region extends \Oro\Bundle\MagentoBundle\Entity\Region implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'combinedCode', 'code', 'countryCode', 'regionId', 'name'];
        }
