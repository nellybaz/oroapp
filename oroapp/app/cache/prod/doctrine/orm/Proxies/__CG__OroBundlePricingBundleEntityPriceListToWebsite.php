 ...
 */
class PriceListToWebsite extends \Oro\Bundle\PricingBundle\Entity\PriceListToWebsite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'sortOrder', 'priceList', 'website', 'mergeAllowed'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PriceListToWebsite $proxy) {
