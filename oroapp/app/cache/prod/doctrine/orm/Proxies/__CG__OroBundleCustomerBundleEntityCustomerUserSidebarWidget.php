 ...
 */
class CustomerUserSidebarWidget extends \Oro\Bundle\CustomerBundle\Entity\CustomerUserSidebarWidget implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomerUserSidebarWidget $proxy) {
