 ...
 */
class DataField extends \Oro\Bundle\DotmailerBundle\Entity\DataField implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'channel', 'name', 'defaultValue', 'notes', 'forceRemove', 'owner', 'createdAt', 'visibility', 'type', 'serialized_data'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DataField $proxy) {
    ...
    public function isForceRemove()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isForceRemove', []);

        return parent::isForceRemove();
    }
    ...
    public function setForceRemove($forceRemove)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setForceRemove', [$forceRemove]);

        return parent::setForceRemove($forceRemove);
    }
