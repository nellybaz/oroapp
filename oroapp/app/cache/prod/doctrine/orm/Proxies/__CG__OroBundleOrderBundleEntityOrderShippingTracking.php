 ...
 */
class OrderShippingTracking extends \Oro\Bundle\OrderBundle\Entity\OrderShippingTracking implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'method', 'number', 'order'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrderShippingTracking $proxy) {
