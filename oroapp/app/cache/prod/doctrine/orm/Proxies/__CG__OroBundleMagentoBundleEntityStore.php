 ...
 */
class Store extends \Oro\Bundle\MagentoBundle\Entity\Store implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'code', 'name', 'website', 'serialized_data', 'channel', 'originId'];
        }
     ...
     * {@inheritDoc}
     */
    public function setWebsite(\Oro\Bundle\MagentoBundle\Entity\Website $website)
    {
