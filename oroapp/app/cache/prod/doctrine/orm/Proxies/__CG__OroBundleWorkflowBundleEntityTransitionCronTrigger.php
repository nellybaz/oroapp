 ...
 */
class TransitionCronTrigger extends \Oro\Bundle\WorkflowBundle\Entity\TransitionCronTrigger implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'cron', 'filter', 'id', 'queued', 'transitionName', 'workflowDefinition', 'createdAt', 'updatedAt', 'updatedAtSet'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TransitionCronTrigger $proxy) {
     ...
     * {@inheritDoc}
     */
    public function import(\Oro\Bundle\WorkflowBundle\Entity\TransitionCronTrigger $trigger)
    {
