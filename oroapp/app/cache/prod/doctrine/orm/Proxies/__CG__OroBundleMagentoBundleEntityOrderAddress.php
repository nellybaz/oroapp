 ...
 */
class OrderAddress extends \Oro\Bundle\MagentoBundle\Entity\OrderAddress implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'types', 'owner', 'fax', 'phone', 'street', 'city', 'postalCode', 'country', 'region', 'label', 'namePrefix', 'middleName', 'nameSuffix', 'street2', 'primary', 'created', 'updated', 'serialized_data', 'id', 'organization', 'regionText', 'firstName', 'lastName', 'channel', 'originId', 'countryText'];
        }
     ...
     * {@inheritDoc}
     */
    public function setOwner(\Oro\Bundle\MagentoBundle\Entity\Order $owner)
    {
