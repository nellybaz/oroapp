 ...
 */
class Tagging extends \Oro\Bundle\TagBundle\Entity\Tagging implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'tag', 'owner', 'created', 'entityName', 'recordId'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTag(\Oro\Bundle\TagBundle\Entity\Tag $tag)
    {
     ...
     * {@inheritDoc}
     */
    public function setResource(\Oro\Bundle\TagBundle\Entity\Taggable $resource)
    {
