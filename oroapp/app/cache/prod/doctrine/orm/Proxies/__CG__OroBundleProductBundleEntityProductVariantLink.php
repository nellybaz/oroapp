 ...
 */
class ProductVariantLink extends \Oro\Bundle\ProductBundle\Entity\ProductVariantLink implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'parentProduct', 'product', 'visible'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductVariantLink $proxy) {
