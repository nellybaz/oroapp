 ...
 */
class PriceAttributePriceList extends \Oro\Bundle\PricingBundle\Entity\PriceAttributePriceList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'prices', 'currencies', 'fieldName', 'id', 'name', 'createdAt', 'updatedAt', 'updatedAtSet'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PriceAttributePriceList $proxy) {
