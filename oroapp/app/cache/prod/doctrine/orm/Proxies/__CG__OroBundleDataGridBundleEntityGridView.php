 ...
 */
class GridView extends \Oro\Bundle\DataGridBundle\Entity\GridView implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'users', 'owner', 'id', 'name', 'type', 'filtersData', 'sortersData', 'columnsData', 'gridName', 'appearanceType', 'appearanceData', 'organization'];
        }
