...
namespace Proxies\__CG__\Oro\Bundle\AbandonedCartBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class AbandonedCartConversion extends \Oro\Bundle\AbandonedCartBundle\Entity\AbandonedCartConversion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'marketingList', 'campaigns'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AbandonedCartConversion $proxy) {
     ...
     * {@inheritDoc}
     */
    public function removeCampaign(\Oro\Bundle\MailChimpBundle\Entity\Campaign $campaign)
    {
     ...
     * {@inheritDoc}
     */
    public function addCampaign(\Oro\Bundle\MailChimpBundle\Entity\Campaign $campaign)
    {
