 ...
 */
class PromotionSchedule extends \Oro\Bundle\PromotionBundle\Entity\PromotionSchedule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'promotion', 'activeAt', 'deactivateAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PromotionSchedule $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setPromotion(\Oro\Bundle\PromotionBundle\Entity\Promotion $promotion)
    {
