 ...
 */
class EV_Ce_Attendee_Status extends \Extend\Entity\EV_Ce_Attendee_Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Ce_Attendee_Status $proxy) {
