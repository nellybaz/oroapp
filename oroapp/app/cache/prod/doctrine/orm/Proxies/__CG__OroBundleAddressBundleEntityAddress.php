 ...
 */
class Address extends \Oro\Bundle\AddressBundle\Entity\Address implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'serialized_data', 'id', 'label', 'street', 'street2', 'city', 'postalCode', 'country', 'region', 'organization', 'regionText', 'namePrefix', 'firstName', 'middleName', 'lastName', 'nameSuffix', 'created', 'updated'];
        }
