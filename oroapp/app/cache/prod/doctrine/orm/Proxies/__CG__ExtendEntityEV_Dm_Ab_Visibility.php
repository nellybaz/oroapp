 ...
 */
class EV_Dm_Ab_Visibility extends \Extend\Entity\EV_Dm_Ab_Visibility implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EV_Dm_Ab_Visibility $proxy) {
