...
/* OroShippingBundle:ShippingMethodsConfigsRule:view.html.twig */
class __TwigTemplate_159eba84f12d2562d2875796a3c244ce9d821ee1b29045fc7b3091ad32a397ef extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("OroUIBundle:actions:view.html.twig", "OroShippingBundle:ShippingMethodsConfigsRule:view.html.twig", 1);
        $this->blocks = array(
    ...
    {
        // line 2
        $context["UI"] = $this->loadTemplate("OroUIBundle::macros.html.twig", "OroShippingBundle:ShippingMethodsConfigsRule:view.html.twig", 2);
        // line 3
        $context["entityConfig"] = $this->loadTemplate("OroEntityConfigBundle::macros.html.twig", "OroShippingBundle:ShippingMethodsConfigsRule:view.html.twig", 3);
        // line 4
        $context["ShipRuleMacro"] = $this->loadTemplate("OroShippingBundle:ShippingMethodsConfigsRule:macros.html.twig", "OroShippingBundle:ShippingMethodsConfigsRule:view.html.twig", 4);
...
($context["entity"] ?? null), "indexPath" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("oro_shipping_methods_configs_rule_index"), "indexLabel" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("oro.shipping.shippingmethodsconfigsrule.entity_plural_label"), "entityTitle" => (($this->getAttribute($this->getAttribute(        // line 13
...
";
    ...
    public function block_content_data($context, array $blocks = array())
    {
        ...
        echo "
                ";
        // line 30
        echo $context["UI"]->getrenderProperty($this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("oro.shipping.shippingmethodsconfigsrule.currency.label"), $this->getAttribute(($context["entity"] ?? null), "currency", array()));
        echo "
                ";
        // line 31
        ...
        if ($this->getAttribute($this->getAttribute(($context["entity"] ?? null), "destinations", array()), "count", array())) {
            // line 34
            echo "                    ";
            echo $context["UI"]->getrenderHtmlProperty($this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("oro.shipping.shippingmethodsconfigsrule.destinations.label"),             // line 36
$context["UI"]->getrenderList($this->getAttribute(($context["entity"] ?? null), "destinations", array())));
        ...
        if ($this->getAttribute($this->getAttribute(($context["entity"] ?? null), "methodConfigs", array()), "count", array())) {
            // line 40
            echo "                    ";
            echo $context["UI"]->getrenderHtmlProperty($this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("oro.shipping.shippingmethodsconfigsrule.method_configs.label"),             // line 42
$context["ShipRuleMacro"]->getrenderShippingMethodsConfigs($this->getAttribute(($context["entity"] ?? null), "methodConfigs", array()), $this->getAttribute(($context["entity"] ?? null), "currency", array())));
            echo "
                ";
        }
        // line 44
        ...
        $context["shippingRuleInformation"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
        // line 51
...
($context["shippingRuleInformation"] ?? null))))));
        // line 60
        echo "
    ";
        // line 61
        $context["id"] = "shipping-rule-view";
        // line 62
        echo "    ";
...
";
    ...
    {
        return "OroShippingBundle:ShippingMethodsConfigsRule:view.html.twig";
    }
    ...
    {
        return new Twig_Source("", "OroShippingBundle:ShippingMethodsConfigsRule:view.html.twig", "");
    }
}
