...
/* OroShoppingListBundle:LineItem/widget:update.html.twig */
class __TwigTemplate_1195d81e375985f6bec83e94983a20bf0f3d8e562f537257cc7ce49ff8718b31 extends Twig_Template
{
...
array_key_exists("savedId", $context)) ? (_twig_default_filter(($context["savedId"] ?? null), null)) : (null)));
     ...
     data-page-component-options=\"";
        // line 7
        echo twig_escape_filter($this->env, twig_jsonencode_filter(twig_array_merge(($context["pageComponentOptions"] ?? null), array("message" => "oro.shoppinglist.line_item_save.flash.success"))), "html", null, true);
        echo "\"
>
    ";
        // line 9
...
";
    ...
    {
        return "OroShoppingListBundle:LineItem/widget:update.html.twig";
    }
    ...
    {
        return new Twig_Source("", "OroShoppingListBundle:LineItem/widget:update.html.twig", "");
    }
}
