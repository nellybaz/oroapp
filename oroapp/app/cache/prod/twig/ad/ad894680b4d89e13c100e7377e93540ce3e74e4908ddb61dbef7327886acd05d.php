...
/* OroShoppingListBundle:layouts/blank/imports/shopping_list_buttons:shopping_list_buttons.html.twig */
class __TwigTemplate_fbd1b591d28df3983bd36af0b8acd60441439ee26a5c4494c682462813176e48 extends Twig_Template
{
    ...
    public function block___shopping_list_buttons__line_item_form_buttons_shopping_list_widget($context, array $blocks = array())
    {
        ...
        if (( !$this->env->getExtension('Oro\Bundle\ProductBundle\Twig\ProductExtension')->isConfigurableType($this->getAttribute(($context["product"] ?? null), "type", array())) || (($context["matrixFormType"] ?? null) != "none"))) {
            // line 3
            echo "        ";
            $context["buttons"] = $this->loadTemplate("OroShoppingListBundle:ShoppingList/Frontend:buttons.html.twig", "OroShoppingListBundle:layouts/blank/imports/shopping_list_buttons:shopping_list_buttons.html.twig", 3);
            // line 4
            echo "
        ";
            // line 5
...
($context["productShoppingLists"] ?? null))), "~singleButtonACss" => "btn--info"));
    ...
    {
        return "OroShoppingListBundle:layouts/blank/imports/shopping_list_buttons:shopping_list_buttons.html.twig";
    }
    ...
    {
        return new Twig_Source("", "OroShoppingListBundle:layouts/blank/imports/shopping_list_buttons:shopping_list_buttons.html.twig", "");
    }
}
