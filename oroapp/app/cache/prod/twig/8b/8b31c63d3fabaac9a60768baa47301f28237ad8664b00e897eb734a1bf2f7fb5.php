...
/* OroTaxBundle:CustomerTaxCode:update.html.twig */
class __TwigTemplate_03040ff612982e2fd0e626e1164a69504b9edb1048d1444d581de9350802f8a7 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("OroUIBundle:actions:update.html.twig", "OroTaxBundle:CustomerTaxCode:update.html.twig", 1);
        $this->blocks = array(
    ...
    {
        // line 3
        $context["formAction"] = (($this->getAttribute(($context["entity"] ?? null), "id", array())) ? ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("oro_tax_customer_tax_code_update", array("id" => $this->getAttribute(($context["entity"] ?? null), "id", array())))) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("oro_tax_customer_tax_code_create")));

        $this->env->getExtension("oro_title")->set(array("params" => array("%taxCode%" => (($this->getAttribute(        // line 5
($context["entity"] ?? null), "code", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["entity"] ?? null), "code", array()), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("N/A"))) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("N/A"))), "%entityName%" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("oro.tax.customertaxcode.entity_label"))));
        // line 1
    ...
    ";
        // line 10
        echo twig_escape_filter($this->env, $this->getAttribute(($context["UI"] ?? null), "cancelButton", array(0 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("oro_tax_customer_tax_code_index")), "method"), "html", null, true);
        echo "
    ";
        // line 11
        ...
        // line 12
        echo "    ";
        if (($this->getAttribute(($context["entity"] ?? null), "id", array()) || $this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("oro_tax_customer_tax_code_update"))) {
            // line 13
            echo "        ";
...
($context["entity"] ?? null), "code", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["entity"] ?? null), "code", array()), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("N/A"))) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("N/A"))));
    ...
    ";
            ...
            // line 28
            echo "        ";
            $context["title"] = $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("oro.ui.create_entity", array("%entityName%" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("oro.tax.customertaxcode.entity_label")));
            // line 29
            echo "        ";
            $this->loadTemplate("OroUIBundle::page_title_block.html.twig", "OroTaxBundle:CustomerTaxCode:update.html.twig", 29)->display(array_merge($context, array("title" => ($context["title"] ?? null))));
            // line 30
            echo "    ";
        }
    }
    ...
    public function block_content_data($context, array $blocks = array())
    {
        // line 34
        echo "    ";
        $context["id"] = "customer-tax-code-edit";
        // line 35
        echo "
    ";
        // line 36
...
";
    ...
    {
        return "OroTaxBundle:CustomerTaxCode:update.html.twig";
    }
    ...
    {
        return new Twig_Source("", "OroTaxBundle:CustomerTaxCode:update.html.twig", "");
    }
}
