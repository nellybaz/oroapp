...
/* OroUserBundle:User:forcePasswordResetButton.html.twig */
class __TwigTemplate_80cae064f0e010c4931d8874f9bed984427a58bc316ca3d8443c23112e6d94f5 extends Twig_Template
{
    ...
    {
        // line 1
        echo twig_escape_filter($this->env, $this->getAttribute(($context["UI"] ?? null), "clientButton", array(0 => array("dataUrl" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("oro_user_send_forced_password_reset_email", array("id" => $this->getAttribute(        // line 2
...
";
    ...
    {
        return "OroUserBundle:User:forcePasswordResetButton.html.twig";
    }
    ...
    {
        return new Twig_Source("", "OroUserBundle:User:forcePasswordResetButton.html.twig", "");
    }
}
