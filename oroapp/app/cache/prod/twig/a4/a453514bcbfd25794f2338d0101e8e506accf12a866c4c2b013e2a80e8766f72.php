...
class __TwigTemplate_37aaf5cf22ec0a568cd31ce9a160609a749ab42858568423087148dd1a38d7d8 extends Twig_Template
{
    ...
    public function block_navbar_tabs($context, array $blocks = array())
    {
        // line 16
        echo "    ";
        $context["options"] = twig_array_merge(($context["options"] ?? null), array("template" => "OroNavigationBundle:Menu:_htabs.html.twig", "depth" => 1));
        // line 17
        echo "    ";
...
";
    ...
    public function block_navbar_tabs_content($context, array $blocks = array())
    {
        // line 21
        echo "    ";
        $context["options"] = twig_array_merge(($context["options"] ?? null), array("template" => "OroNavigationBundle:Menu:_tabs-content.html.twig", "depth" => 1));
        // line 22
        echo "    ";
        echo $this->env->getExtension('Knp\Menu\Twig\MenuExtension')->render(($context["item"] ?? null), ($context["options"] ?? null));
        echo "
";
    ...
    {
        return new Twig_Source("", "OroNavigationBundle:Menu:horizontal_tabs.html.twig", "");
    }
}
