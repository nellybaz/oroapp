...
/* OroFedexShippingBundle::FedexMethodWithOptions.html.twig */
class __TwigTemplate_04de90a836c26391b014bbf0399fee900edebcbfb5d4ece762b659ca30ee96c2 extends Twig_Template
{
    ...
    {
        // line 1
        $context["ShipRuleMacro"] = $this->loadTemplate("OroShippingBundle:ShippingMethodsConfigsRule:macros.html.twig", "OroFedexShippingBundle::FedexMethodWithOptions.html.twig", 1);
        // line 2
        echo "
";
        // line 3
        ...
        if ((twig_length_filter($this->env, ($context["methodLabel"] ?? null)) > 0)) {
            ...
            if ( !twig_test_empty($this->getAttribute($this->getAttribute(($context["methodData"] ?? null), "options", array()), "surcharge", array()))) {
                // line 8
                echo "&nbsp;(";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("oro.fedex.shipping_method_options.surcharge.label"), "html", null, true);
                echo ": ";
    ...
    {
        return "OroFedexShippingBundle::FedexMethodWithOptions.html.twig";
    }
    ...
    {
        return new Twig_Source("", "OroFedexShippingBundle::FedexMethodWithOptions.html.twig", "");
    }
}
