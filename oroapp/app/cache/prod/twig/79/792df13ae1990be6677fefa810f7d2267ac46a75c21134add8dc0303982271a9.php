...
class __TwigTemplate_bbcbedf186e1f9005f1879c57e8357dfbb0f5fbef4c2f6587eb8bca00becc559 extends Twig_Template
{
    ...
    {
        // line 1
        $context["colors"] = ((array_key_exists("colors", $context)) ? (_twig_default_filter(($context["colors"] ?? null), array("light" => "#AAA", "dark" => "#555"))) : (array("light" => "#AAA", "dark" => "#555")));
        // line 2
        echo "
<svg version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"28.004px\" height=\"24px\" viewBox=\"0 0 28.004 24\" enable-background=\"new 0 0 28.004 24\" xml:space=\"preserve\">
    <path style=\"fill:";
        // line 4
        echo twig_escape_filter($this->env, $this->getAttribute(($context["colors"] ?? null), "light", array()), "html", null, true);
        echo " !important\" fill=\"";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["colors"] ?? null), "light", array()), "html", null, true);
    ...
    <path style=\"fill:";
        // line 5
        echo twig_escape_filter($this->env, $this->getAttribute(($context["colors"] ?? null), "dark", array()), "html", null, true);
        echo " !important\" fill=\"";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["colors"] ?? null), "dark", array()), "html", null, true);
...
";
    ...
    {
        return array (  31 => 5,  25 => 4,  21 => 2,  19 => 1,);
    }
    ...
    {
        return new Twig_Source("", "SncRedisBundle:Collector:icon.svg.twig", "");
    }
}
