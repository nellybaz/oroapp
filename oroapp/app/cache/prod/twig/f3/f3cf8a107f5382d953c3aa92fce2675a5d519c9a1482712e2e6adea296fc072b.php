...
class __TwigTemplate_c91b53259c9fdfc97928c1367cd874474ef3dc1e153908a62965c41425a9fe30 extends Twig_Template
{
    ...
    {
        // line 1
        echo twig_escape_filter($this->env, $this->getAttribute(($context["UI"] ?? null), "clientButton", array(0 => array("dataUrl" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("oro_attachment_create", array("entityClass" => $this->env->getExtension('Oro\Bundle\EntityBundle\Twig\EntityExtension')->getClassName(        // line 4
...
";
    ...
    {
        return "OroAttachmentBundle:Attachment:addButton.html.twig";
    }
    ...
    {
        return new Twig_Source("", "OroAttachmentBundle:Attachment:addButton.html.twig", "");
    }
}
