...
/* OroRFPBundle:Request/block:viewButtons.html.twig */
class __TwigTemplate_69ff590a5d59e68dea901a7fb7036d430f3fb9b34e52b75f815b12afd78b19a5 extends Twig_Template
{
    ...
    {
        // line 1
        $context["UI"] = $this->loadTemplate("OroUIBundle::macros.html.twig", "OroRFPBundle:Request/block:viewButtons.html.twig", 1);
        // line 2
        ...
        foreach ($context['_seq'] as $context["groupName"] => $context["group"]) {
            ...
            if (twig_test_empty($context["groupName"])) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["widget"]) {
                    // line 5
                    $this->loadTemplate($this->getAttribute($this->getAttribute($context["widget"], "button", array()), "template", array()), "OroRFPBundle:Request/block:viewButtons.html.twig", 5)->display(array_merge($context, array("data" => (($this->getAttribute($this->getAttribute($context["widget"], "button", array(), "any", false, true), "data", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($context["widget"], "button", array(), "any", false, true), "data", array()), array())) : (array())))));
                    ++$context['loop']['index0'];
                    ++$context['loop']['index'];
...
($context["items"] ?? null))));
    ...
    {
        return "OroRFPBundle:Request/block:viewButtons.html.twig";
    }
    ...
    {
        return new Twig_Source("", "OroRFPBundle:Request/block:viewButtons.html.twig", "");
    }
}
