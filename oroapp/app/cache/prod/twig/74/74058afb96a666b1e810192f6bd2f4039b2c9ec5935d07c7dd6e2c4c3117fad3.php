...
class __TwigTemplate_2184783de6573e5097be7228f8c2eb6756df19750b51680d18e1f49a5a905d2d extends Twig_Template
{
    ...
    ";
        ...
        echo "        <div class=\"responsive-section\">
            ...
            <div class=\"row-fluid row-fluid-divider\">
                <fieldset class=\"form-horizontal span6\">
                    <h5 class=\"user-fieldset\"><span>Basic Information</span></h5>
        ...
        // line 90
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("should have min 3 symbols"), "html", null, true);
        echo "</span>
                        </div>
                    </div>
                    <div class=\"control-group\">
                    ...
                    <div class=\"control-group datepicker \">
                        ...
                        <div class=\"controls validation-error\">
                            ...
                            <span class=\"validation-failed\">";
        // line 109
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("some msgs span two lines <br/> use mm/dd/yy format");
        echo "</span>
                        </div>
                    </div>
                    <div class=\"control-group\">
                ...
                <fieldset class=\"form-horizontal span6\">
                    <h5 class=\"user-fieldset\"><span>Contact Information</span></h5>
...
";
    ...
    {
        return new Twig_Source("", "OroUIBundle:Default:formHorizontal.html.twig", "");
    }
}
