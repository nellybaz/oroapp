...
/* OroWorkflowBundle:layouts/default/imports/oro_workflow_transition_form:layout.html.twig */
class __TwigTemplate_56a1d9532845241382b3070496eca86a1148e48b18e53803998090b107688c0b extends Twig_Template
{
...
($context["attr"] ?? null), "class", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["attr"] ?? null), "class", array()), "")) : ("")) . " transition-form-widget")));
        // line 5
        echo "    <div";
...
";
    ...
    {
        return "OroWorkflowBundle:layouts/default/imports/oro_workflow_transition_form:layout.html.twig";
    }
    ...
    {
        return new Twig_Source("", "OroWorkflowBundle:layouts/default/imports/oro_workflow_transition_form:layout.html.twig", "");
    }
}
