...
class __TwigTemplate_bd28d1673891afccf42e5313d4874713f37bd23696041e894714373a67548736 extends Twig_Template
{
    ...
    {
        // line 1
        return $this->loadTemplate((((($context["status_code"] ?? $this->getContext($context, "status_code")) == 403)) ? ("OroUIBundle:Default:index.html.twig") : ("TwigBundle::layout.html.twig")), "TwigBundle:Exception:exception_full.html.twig", 1);
    }
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 3
        $context["pageTitle"] = ((((($context["status_code"] ?? $this->getContext($context, "status_code")) . " ") . ($context["status_text"] ?? $this->getContext($context, "status_text"))) . " - ") . $this->getAttribute(($context["exception"] ?? $this->getContext($context, "exception")), "message", array()));

        $this->env->getExtension("oro_title")->set(array("titleTemplate" =>         // line 4
($context["pageTitle"] ?? $this->getContext($context, "pageTitle")), "force" => true));
        // line 1
...
";
    ...
    {
        return array (  138 => 29,  132 => 28,  129 => 27,  123 => 26,  115 => 23,  109 => 22,  95 => 19,  89 => 18,  78 => 15,  67 => 12,  56 => 9,  45 => 6,  38 => 1,  36 => 4,  33 => 3,  24 => 1,);
    }
    ...
    {
        return new Twig_Source("{% extends status_code == 403 ? 'OroUIBundle:Default:index.html.twig' : 'TwigBundle::layout.html.twig' %}
...
{% block content %}
    <div class=\"alert alert-block pagination-centered popup-box\">
        ...
        <img src=\"{{ asset('bundles/oroui/img/503.png') }}\" alt=\"Error page\" />
    </div>
{% endblock %}
